...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="price.html" class="dropdown-item active"><span>Pricing</span></a></li>
    ...
    <!-- Header Banner -->
    <section class="banner-header section-padding bg-img" data-overlay-dark="6" data-background="img/slider/23.jpg">
        <div class="v-middle">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h6 class="fade-in-text">Pricing Plans</h6>
                        <h1>Packages</h1>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 mb-30">
                    <div class="item">
                        <h3>Standart Plan <span>per day</span></h3>
                        <div class="cont">
                            <ul class="dot-list">
                                ...
                                <li>GPS navigation available as an add-on</li>
                            </ul><br>
                            <p>🚗 Ideal for: Daily commutes, city travel, and budget-friendly trips</p><a
                                data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" href="#0"
                                class="button-1 mt-30">Rent Now <span class="ti-arrow-top-right"></span></a>
                        </div>
                        <a data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" href="#0"
                            class="rmore">
                            <div class="arrow"> <span>Kes</span> 15360</div>
                ...
                <div class="col-lg-4 col-md-12 mb-30">
                    <div class="item">
                        <h3>Pro Plan <span>per day</span></h3>
                        <div class="cont">
                            <ul class="dot-list">
                                <li>Comprehensive insurance coverage</li>
                                <li>Mid-range luxury vehicles</li>
                                <li> Free GPS navigation</li>
                                <li>Unlimited mileage</li>
                                <li>Complimentary roadside assistance</li>
                            </ul><br>
                            <p>🚗 Ideal for: Business trips, family vacations, and comfortable long drives</p><a
                                data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" href="#0"
                                class="button-1 mt-30">Rent Now <span class="ti-arrow-top-right"></span></a>
                        </div>
                        <a data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" href="#0"
                            class="rmore active">
                            <div class="arrow"> <span>kes</span> 19200</div>
                            <div class="br-left-top">
                                <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                                    class="w-11 h-11">
                                    <path
                ...
                <div class="col-lg-4 col-md-12 mb-30">
                    <div class="item">
                        <h3>Premium Plan <span>per day</span></h3>
                        <div class="cont">
                            <ul class="dot-list">
                                <li>Full insurance coverage</li>
                                <li>Free GPS & WiFi connectivity</li>
                                <li>Chauffeur service available/li>
                                <li> High-end luxury cars</li>
                                <li>Priority support and premium roadside assistance</li>

                            </ul><br>
                            <p>🚗 Ideal for: VIP clients, luxury experiences, and business executives</p> <a
                                data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" href="#0"
                                class="button-1 mt-30">Rent Now <span class="ti-arrow-top-right"></span></a>
                        </div>
                        <a data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" href="#0"
                            class="rmore">
                            <div class="arrow"> <span>kes</span> 23040</div>
                            <div class="br-left-top">
                                <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                                    class="w-11 h-11">
                                    <path

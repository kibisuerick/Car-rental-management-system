...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    <div class="item active"> <span class="icon ti-money"></span>
                        <h5>Affordable Rates</h5>
                        <p>We are constantly keeping an eye on the prices to make sure we'll get you the best deal there is on the market.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12">
                    <div class="item"> <span class="icon omfi-transmission"></span>
                        <h5>Amazing Fleet of Cars</h5>
                        <p>We have an exclusive fleet of cars available for you. You can check out our car page for detailed information.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12">
                    <div class="item"> <span class="icon omfi-location"></span>
                        <h5>Deliverd at your Location</h5>
                        <p>We come to your location and deliver the vehicle to you. Don't forget to check out our other services!</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Booking Search -->
    <section id="bookingseach" data-scroll-index="8" class="background bg-img bg-fixed section-padding" data-overlay-dark="5" data-background="img/slider/2.jpg">
        <div class="container">
            <div class="row">
                ...
                <div class="owl-theme owl-carousel">
                    <div class="item mb-15">
                       <div class="project-date">
                            <a href="car-details.php" class="br">
                                <div class="year">kes 95000 <span>/ day</span></div>
                            </a>
                            <div class="br-left-top">
                                <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                    <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                        ...
                        <a href="car-details.php" class="img"> 
                            <img src="img/blog/8.jpg" alt="" class="img-fluid">
                            <div class="bottom-fade"></div>
                            <div class="arrow"> <i class="ti-arrow-right"></i> </div>
                        </a>
                        <div class="info">
                            <div class="title"><a href="car-details.php">Bugatti Mistral W16</a></div>
                            <div class="details"> 
                    ...
                    <div class="item mb-15">
                       <div class="project-date">
                            <a href="car-details.php" class="br">
                                <div class="year">Kes 65,000<br><span>/ day</span></div>
                            </a>
                            <div class="br-left-top">
                                <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                    <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                        ...
                        <a href="post.php" class="img"> 
                            <img src="img/blog/stylish-black-woman-car-salon_1157-21421.avif" alt="" class="img-fluid">
                            <div class="bottom-fade"></div>
                            <div class="arrow"> <i class="ti-arrow-right"></i> </div>
                        </a>
                        <div class="info">
                            <div class="title"><a href="post.php">Audi RS7 Sportback</a></div>
                            <div class="details"> 
                    ...
                    <div class="item mb-15">
                       <div class="project-date">
                            <a href="car-details.php" class="br">
                                <div class="year">Kes 102,000<br><span>/ day</span></div>
                            </a>
                            <div class="br-left-top">
                                <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                    <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                        ...
                        <div class="info">
                            <div class="title"><a href="post.php">Bugatti Mistral W16</a></div>
                            <div class="details"> 
                                <span><i class="omfi-door"></i> 4 Seats</span>
                                <span><i class="omfi-transmission"></i> Auto</span>
                                <span><i class="omfi-luggage"></i> 2 Bags</span>
                    ...
                    <div class="item mb-15">
                       <div class="project-date">
                            <a href="car-details.php" class="br">
                                <div class="year">kes 50000<br><span>/ day</span></div>
                            </a>
                            <div class="br-left-top">
                                <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                    <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                        ...
                        <div class="info">
                            <div class="title"><a href="post.php">AUDI Q8</a></div>
                            <div class="details"> 
                                <span><i class="omfi-door"></i> 4 Seats</span>
                                <span><i class="omfi-transmission"></i> Auto</span>
                    ...
                    <div class="item mb-15">
                       <div class="project-date">
                        ...
                        <a href="post.php" class="img"> 
                            <img src="img/blog/1african-american-business-man-car_1303-9853.avif" alt="" class="img-fluid">
                            <div class="bottom-fade"></div>
                            <div class="arrow"> <i class="ti-arrow-right"></i> </div>
                        </a>
                        <div class="info">
                            <div class="title"><a href="post.php">Bentley Bentayga</a></div>
                            <div class="details"> 
                                <span><i class="omfi-door"></i> 4 Seats</span>
                                <span><i class="omfi-transmission"></i> Auto</span>
                                <span><i class="omfi-luggage"></i> 2 Bags</span>
                    ...
                    <div class="item mb-15">
                       <div class="project-date">
                            <a href="car-details.php" class="br">
                                <div class="year">kes 70,400<br><span>/ day</span></div>
                            </a>
                            <div class="br-left-top">
                                <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                    <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                        ...
                        <div class="info">
                            <div class="title"><a href="post.php">Aston Martin DBS</a></div>
                            <div class="details"> 
                                <span><i class="omfi-door"></i> 4 Seats</span>
                                <span><i class="omfi-transmission"></i> Auto</span>
                                <span><i class="omfi-luggage"></i> 2 Bags</span>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="item mb-15">
                            <div class="img"> <img src="img/cars/06.jpg"
                        ...
                        <div class="item mb-15">
                            <div class="img"> <img src="img/cars/05.jpg"
                                    class="img-fluid" alt=""> </div>
                            <div class="info">
                                <h2 class="title">Luxury Cars</h2>
                                <p class="subtitle">Car Types</p>
                        ...
                        <div class="item mb-15">
                            <div class="img"> <img src="img/cars/c2.jpg" class="img-fluid" alt=""> </div>
                            <div class="info">
                                <h2 class="title">Convertible</h2>
                                <p class="subtitle">Car Types</p>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="img"> <img src="img/blog/10.jpg" alt=""> </div>
                            <div class="wrapper">
                        ...
                        <div class="item">
                            <div class="img"> <img src="img/blog/06.jpg" alt="">
                            </div>
                            <div class="wrapper">
    ...
    <!-- Lets Talk -->
    <section id="contact" data-scroll-index="7" class="lets-talk bg-img bg-fixed section-padding" data-overlay-dark="5" data-background="img/slider/3.jpg">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h6 class="fade-in-text">Rent Your Car</h6>
    ...
    <script>
        $(document).ready(function() {
            $('#kenburnsSliderContainer').vegas({
                slides: [{
                    src: "img/slider/african-american-business-man-car_1303-9853.avif"
                }, {
                    src: "img/slider/3.jpg"
                }, {
                    src: "img/slider/1african-american-business-man-car_1303-9853.avif"
                }],
                overlay: true,
                transition: 'fade2',

...
<body>
    ...
    <!-- Parallax Image 2 -->
    <section id="home" data-scroll-index="0" class="parallax-header2 section-padding valign bg-img bg-fixed" data-overlay-dark="6" data-background="img/slider/23.jpg">
        <div class="container">

                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu dropdown"> <a class="dropdown-item active dropdown-toggle"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="car-types2.html" class="dropdown-item active"><span>Car Types 02</span></a></li>
    ...
    <section class="car-types2 section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="item">
                        <a href="car-details.html"> <span class="flaticon-minivan-car"></span>
                            <h6 class="fade-in-text">Minivan</h6>
                        </a>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="item">
                        <a href="car-details.html"> <span class="flaticon-car"></span>
                            <h6 class="fade-in-text">Small Cars</h6>
                        </a>

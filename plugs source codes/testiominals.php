                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="testiominals.html" class="dropdown-item active"><span>Testiominals</span></a>
                            </li>
    ...
    <section class="banner-header section-padding bg-img" data-overlay-dark="6" data-background="img/slider/3.jpg">
        <div class="v-middle">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="fade-in-text">Testimonials</h6>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-60">
                    <div class="item">
                        ...
                        <div class="text">
                            <p>Reliable and affordable! The car selection is fantastic, and the service was hassle-free
                                from start to finish. A truly five-star experience!</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-60">
                    <div class="item">
                        ...
                        <div class="text">
                            <p>Renting a car has never been easier! The process was smooth, the vehicle was in excellent
                                condition, and the customer service was top-notch. Highly recommended!</p>
                        </div>
                        <div class="info mt-30">
                            <div class="img-curv">
                                <div class="img"> <img
                    ...
                    <div class="item">
                        ...
                        <div class="text">
                            <p>I had an amazing experience with this rental service. The team was professional, the
                                booking was quick, and the car exceeded my expectations. Will definitely rent again!</p>
                        </div>
                        <div class="info mt-30">
                            <div class="img-curv">
                ...
                <div class="col-lg-4 col-md-6 mb-60">
                    <div class="item">
                        ...
                        <div class="info mt-30">
                            ...
                            <div class="ml-30">
                                <h6 class="fade-in-text">Robert Frank</h6>
                                <p>Customer</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-60">
                    <div class="item">
                        ...
                        <div class="info mt-30">
                            <div class="img-curv">
                                <div class="img"> <img src="img/team/african-american-business-man-car_1303-9852.avif"
                                        alt=""> </div>
                                <div class="shap-left-top">
                                    <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                                        class="w-11 h-11">
                            ...
                            <div class="ml-30">
                                <h6 class="fade-in-text">Jesica Mccury</h6>
                                <p>Customer</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-60">
                    <div class="item">
                        ...
                        <div class="info mt-30">
                            <div class="img-curv">
                                <div class="img"> <img
                                        src="img/team/industrial-designer-working-3d-model_23-2149370152.avif" alt="">
                                </div>
                                <div class="shap-left-top">
                                    <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                                        class="w-11 h-11">
                            ...
                            <div class="ml-30">
                                <h6 class="fade-in-text">Evelyn Elena</h6>
                                <p>Customer</p>
                            </div>
                        </div>
                    </div>

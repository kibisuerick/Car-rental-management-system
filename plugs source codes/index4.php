                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="index4.php" class="dropdown-item active"><span>Slideshow</span></a></li>
                ...
                <div class="container">
                    <div class="row h-100">
                        <div class="col-md-12">
                            ...
                            <a href="#" data-scroll-nav="1" class="button-2 mt-15 mb-15">Rent Now <span
                                    class="ti-arrow-top-right"></span></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    <div class="item active"> <span class="icon ti-money"></span>
                        ...
                        <p>We are constantly keeping an eye on the prices to make sure we'll get you the best deal there
                            is on the market.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12">
                    <div class="item"> <span class="icon omfi-transmission"></span>
                        ...
                        <p>We have an exclusive fleet of cars available for you. You can check out our car page for
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="item"> <span class="icon omfi-location"></span>
                        ...
                        <p>We come to your location and deliver the vehicle to you. Don't forget to check out our other
                            services!</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="text">
                                ...
                                <p>Effortlessly manage your corporate travel with our premium car rental services.
                                    Whether for executive meetings, corporate events, or employee transportation, we
                                    offer a fleet of high-end vehicles to meet your business needs. Enjoy flexibility,
                                    reliability, and professionalism with every ride.</p>
                            </div>
                            <div class="numb">
                                <div class="numb-curv">
                        ...
                        <div class="item">
                            <div class="text">
                                ...
                                <p>Sit back and relax while our professional chauffeurs take you to your destination
                                    safely and comfortably. Our car rental with driver service is perfect for business
                                    trips, special occasions, or city tours. Experience seamless transportation with
                                    experienced drivers who prioritize your comfort and punctuality.</p>
                            </div>
                            <div class="numb">
                                <div class="numb-curv">
                                    <a href="service-details.php">
                        ...
                        <div class="item">
                            <div class="text">
                                ...
                                <p>Start and end your journey stress-free with our airport transfer service. We provide
                                    timely pickups and drop-offs, ensuring you reach your destination on time. Whether
                                    traveling for business or leisure, our fleet is available 24/7 to provide a smooth
                        ...
                        <div class="item">
                            <div class="text">
                                <h5>Fleet Leasing</h5>
                                <p>Optimize your business operations with our flexible fleet leasing solutions. Whether
                                    you need a single vehicle or an entire fleet, we offer cost-effective,
                                    well-maintained cars tailored to your corporate or personal needs. Enjoy hassle-free
                                    leasing with full support and maintenance.</p>
                            </div>
                            <div class="numb">
                                <div class="numb-curv">
                                    <a href="service-details.php">
                        ...
                        <div class="item">
                            <div class="text">
                                <h5>VIP Transfer</h5>
                                <p>Experience luxury and exclusivity with our VIP transfer service. Designed for
                                    executives, celebrities, and high-profile individuals, we provide premium vehicles
                                    with professional chauffeurs for a smooth and stylish ride. Travel in comfort,
                        ...
                        <div class="item">
                            <div class="text">
                                ...
                                <p>Get personalized and comfortable travel with our private transfer services. Whether
                                    for business or leisure, enjoy door-to-door service with well-maintained vehicles
                                    and experienced drivers. Avoid the hassle of public transport and ride in peace.</p>
                            </div>
                            <div class="numb">
                                <div class="numb-curv">
                                    <a href="service-details.php">
                ...
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            ...
                            <a href="car-details.php" class="img"> <img src="img/blog/8.jpg" alt="" class="img-fluid">
                            ...
                            <div class="info">
                                ...
                                <div class="details"> <span><i class="omfi-door"></i> 2 Seats</span> <span><i
                                            class="omfi-transmission"></i> Auto</span> <span><i class="omfi-age"></i>
                                        Age 25</span> </div>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <a href="post.php" class="img"> <img
                                    src="img/blog/stylish-black-woman-car-salon_1157-21421.avif" alt=""
                                    class="img-fluid">
                                <div class="bottom-fade"></div>
                                <div class="arrow"> <i class="ti-arrow-right"></i> </div>
                            </a>
                        ...
                        <div class="item">
                            ...
                            <a href="post.php" class="img"> <img src="img/blog/9.jpg" alt="" class="img-fluid">
                                <div class="bottom-fade"></div>
                                <div class="arrow"> <i class="ti-arrow-right"></i> </div>
                            </a>
                            <div class="info">
                        ...
                        <div class="item">
                            ...
                            <a href="post.php" class="img"> <img src="img/blog/10.jpg" alt="" class="img-fluid">
                                <div class="bottom-fade"></div>
                                <div class="arrow"> <i class="ti-arrow-right"></i> </div>
                            </a>
                            <div class="info">
                                ...
                                <div class="details"> <span><i class="omfi-door"></i> 4 Seats</span> <span><i
                                            class="omfi-transmission"></i> Auto</span> <span><i
                                            class="omfi-luggage"></i> 3 Bags</span> </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="project-date">
                            ...
                            <a href="post.php" class="img"> <img
                                    src="img/blog/1african-american-business-man-car_1303-9853.avif" alt=""
                                    class="img-fluid">
                                <div class="bottom-fade"></div>
                                <div class="arrow"> <i class="ti-arrow-right"></i> </div>
                            </a>
                        ...
                        <div class="item">
                            ...
                            <a href="post.php" class="img"> <img src="img/blog/7.jpg" alt="" class="img-fluid">
                                <div class="bottom-fade"></div>
                                <div class="arrow"> <i class="ti-arrow-right"></i> </div>
                            </a>
                            <div class="info">
                ...
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item"> <img src="img/cars/03.jpg" class="img-fluid" alt="">
                            ...
                            <div class="curv-butn icon-bg">
                                <a href="car-details.php" class="vid">
                        ...
                        <div class="item"> <img src="img/cars/0african-american-business-man-car_1303-9853.avif"
                                class="img-fluid" alt="">
                            <div class="title">
                                <h4>Convertible</h4>
                            </div>
                        ...
                        <div class="item"> <img src="img/cars/0stylish-black-woman-car-salon_1157-21421.avif"
                                class="img-fluid" alt="">
                            <div class="title">
                                <h4>Small Cars</h4>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item"> <img src="img/blog/3.jpg" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                                <h6 class="fade-in-text">Rental</h6>
                                <h4>Documents required for car rental</h4>
                            </div>
                            <div class="curv-butn icon-bg">
                                <a href="post.php" class="vid">
                        ...
                        <div class="item"> <img
                                src="img/blog/car-insurance-tablet-black-woman-portrait-with-motor-evaluation-inspection-from-hire-road-trip-digital-accident-report-auto-search-outdoor-w.avif"
                                class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                        ...
                        <div class="item"> <img src="img/blog/5.jpg" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                                <h6 class="fade-in-text">Fines</h6>
                        ...
                        <div class="item"> <img src="img/blog/stylish-black-woman-car-salon_1157-21421.avif"
                            ...
                            <div class="bottom-fade"></div>
                            <div class="title">
                                <h6 class="fade-in-text">Airport</h6>
                        ...
                        <div class="item"> <img src="img/blog/7.jpg" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                                <h6 class="fade-in-text">Rules</h6>
                        ...
                        <div class="item"> <img src="img/blog/8.jpg" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                                <h6 class="fade-in-text">Rental Car</h6>

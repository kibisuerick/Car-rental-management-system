...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="team-single.html" class="dropdown-item active"><span>Team Single</span></a>
                            </li>
    ...
    <section class="banner-header section-padding bg-img" data-overlay-dark="6"
        data-background="img/slider/2african-american-business-man-car_1303-9853.avif">
        <div class="v-middle">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h6 class="fade-in-text">Sales Consultant</h6>
                        <h1>Daniel Otieno</h1>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12">
                    <div class="team-img mb-30">
                        <div class="img">
                            <img src="img/team/young-black-businessman-auto-salon-car-sale-rent-concept_146671-18401.avif"
                        ...
                        <div class="wrapper text-center mt-3">
                            ...
                            <p class="mt-2">My e-mail address:
                                <a href="mailto:florence.mwaiflorence384@gmail.com"
                                    class="text-primary">florence.mwaiflorence384@gmail.com</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 offset-lg-1 col-md-12">
                    <h6 class="fade-in-text">Hello, Daniel Otieno here. I work as your sales consultant at Carnex Luxury
                        Car Rental.</h6>
                    <p>At Carnex, I am committed to helping clients find the perfect luxury vehicle for their needs.
                        Whether you require a premium ride for business, travel, or a special occasion, I ensure a
                        seamless rental experience with top-tier customer service. With extensive knowledge of our fleet
                        and rental policies, I provide tailored recommendations to match your preferences.
                    </p>

                    <!-- Qualifications List -->
                    <ul class="list-unstyled list mb-4">
                        <li><i class="ti-check"></i> B Driver License</li>
                        <li><i class="ti-check"></i> Bachelor's Degree</li>
                        <li><i class="ti-check"></i> Fluent in English</li>
                    </ul>

                    <!-- Tabs -->
                    <ul class="nav nav-tabs simpl-bord mt-3" id="myTab" role="tablist">
                        <li class="nav-item">
                            <span class="nav-link active cursor-pointer" style="color: #ffc107;" data-bs-toggle="tab"
                                data-bs-target="#biography">Biography</span>
                        </li>
                        <li class="nav-item">
                            <span class="nav-link cursor-pointer" style="color: #ffc107;" data-bs-toggle="tab"
                                data-bs-target="#education">Education</span>
                        </li>
                        <li class="nav-item">
                            <span class="nav-link cursor-pointer" style="color: #ffc107;" data-bs-toggle="tab"
                                data-bs-target="#awards">Awards</span>
                        </li>
                    </ul>
                    <!--Tabs-->
                    ...
                    <div class="tab-content mt-3" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="biography">
                            <p>Daniel Otieno is a dedicated sales consultant at Carnex Luxury Car Rental, bringing years
                                of expertise in customer relations and premium vehicle leasing. With a passion for
                                luxury automobiles and a keen understanding of client needs, he ensures that every
                                customer enjoys a seamless and personalized rental experience. His commitment to
                                excellence and in-depth knowledge of the industry make him a valuable asset to the
                                Carnex
                                team.</p>
                        </div>
                        ...
                        <div class="tab-pane fade" id="education">
                            <p><strong>Bachelor’s Degree in Business Administration</strong> – University of Nairobi</p>
                            <p>Specialized in sales and marketing, focusing on customer relations and business strategy.
                            </p>
                            <p><strong>Certified Customer Service Excellence Training</strong> – Kenya Institute of
                                Management</p>
                            <p>Enhanced skills in communication, conflict resolution, and client satisfaction
                                strategies.</p>
                            <p><strong>Advanced Driving Certification</strong> – AA Kenya</p>
                            <p>Trained in defensive driving and luxury vehicle handling.</p>
                        </div>

                        <!-- Awards -->
                        <div class="tab-pane fade" id="awards">
                            <p>🏆 <strong>Best Customer Service Excellence Award</strong> – Kenya Car Rental Association
                                (2024)</p>
                            <p>🏆 <strong>Top Rental Management Innovator</strong> – Nairobi Business Excellence Awards
                                (2023)</p>
                            <p>🏆 <strong>Outstanding Fleet Management Recognition</strong> – Auto Industry Leaders
                                Summit (2022)</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item"> <img
                                src="img/team/young-black-businessman-auto-salon-car-sale-rent-concept_146671-18401.avif"
                                class="img-fluid" alt="">
                        ...
                        <div class="item"> <img
                                src="img/team/car-insurance-tablet-black-woman-portrait-with-motor-evaluation-inspection-from-hire-road-trip-digital-accident-report-auto-search-outdoor-w.avif"
                                class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="info">
                                <div class="butn icon-bg">
                        ...
                        <div class="item"> <img src="img/team/industrial-designer-working-3d-model_23-2149370152.avif"
                                class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="info">
                                <div class="butn icon-bg">
                        ...
                        <div class="item"> <img src="img/team/african-american-business-man-car_1303-9852.avif"
                                class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="butn icon-bg">
                                <a href="team-single.html" class="vid">
                            ...
                            <div class="title">
                                <h4>Elvis Mugisira</h4>
                                <h6 class="fade-in-text">Sales Department</h6>
                            </div>
                        </div>
                        <div class="item"> <img src="img/team/stylish-black-woman-car-salon_1157-21421.avif"
                                class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="butn icon-bg">
                                <a href="team-single.html" class="vid">
                            ...
                            <div class="title">
                                <h4>Mia Jane</h4>
                                <h6 class="fade-in-text">Finance Department</h6>
                            </div>
                        </div>

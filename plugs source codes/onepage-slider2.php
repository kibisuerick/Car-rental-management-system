...
<body>
    ...
    <header id="home" data-scroll-index="0"  class="header slider-fade">
        <div class="owl-carousel owl-theme">
            ...
            <div class="item bg-img" data-overlay-dark="6" data-background="img/slider/1.jpg">
                <div class="v-middle">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 col-md-12">
                                <div class="caption">
                                    <h6 class="fade-in-text">* Economy</h6>
                                    <h2 class="animated-text">Bugatti Mistral W16</h2>
                                    <h5>Reserve now and get the best offer <span>Kes 90,000 <i>/ day</i></span></h5> <a href="#0" class="button-1 mt-15 mb-15">View Details <span class="ti-arrow-top-right"></span></a> <a href="#" data-scroll-nav="1" class="button-2 mt-15 mb-15">Rent Now <span class="ti-arrow-top-right"></span></a>
                                </div>
                            </div>
            ...
            <div class="item bg-img" data-overlay-dark="6" data-background="img/slider/11.jpg">
                <div class="v-middle">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 col-md-12">
                                <div class="caption">
                                    <h6 class="fade-in-text">* Economy</h6>
                                    <h2 class="animated-text">Bentley Bentayga</h2>
                                    <h5>Reserve now and get the best offer <span>Kes 65,000 <i>/ day</i></span></h5> <a href="#0" class="button-1 mt-15 mb-15">View Details <span class="ti-arrow-top-right"></span></a> <a href="#" data-scroll-nav="1" class="button-2 mt-15 mb-15">Rent Now <span class="ti-arrow-top-right"></span></a>
                                </div>
                            </div>
                            <div class="col-lg-4 offset-lg-1 col-md-12">
                                <div class="car-features">
            ...
            <div class="item bg-img" data-overlay-dark="6" data-background="img/slider/12.jpg">
                <div class="v-middle">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 col-md-12">
                                <div class="caption">
                                    <h6 class="fade-in-text">* Economy</h6>
                                    <h2 class="animated-text">Rolls Royce Cullinan</h2>
                                    <h5>Reserve now and get the best offer <span>Kes 102,000 <i>/ day</i></span></h5> <a href="#0" class="button-1 mt-15 mb-15">View Details <span class="ti-arrow-top-right"></span></a> <a href="#" data-scroll-nav="1" class="button-2 mt-15 mb-15">Rent Now <span class="ti-arrow-top-right"></span></a>
                                </div>
                            </div>
                            <div class="col-lg-4 offset-lg-1 col-md-12">
                                <div class="car-features">

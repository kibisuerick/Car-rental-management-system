...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="index6.php" class="dropdown-item active"><span>Grid Background</span></a></li>
    ...
    <section class="slider-grid-bg valign">
        <!-- The opacity on the image is made with "data-overlay-dark="number". You can change it using the numbers 0-9. -->
        <div style="background-image: url('img/slider/25.jpg')" class="grid-img grid-img-active" data-overlay-dark="4">
        </div>
        <div style="background-image: url('img/slider/2stylish-black-woman-car-salon_1157-21421.avif')" class="grid-img"
            data-overlay-dark="4"></div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="#0" class="grid-con grid-con-active">
                            ...
                            <div class="text"> <span class="subtitle">Aston</span> <span class="title">Aston Martin
                                    DBS</span> </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="#0" class="grid-con">
                            <span class="arrow"><i class="ti-arrow-top-right"></i></span>
                            <div class="text"> <span class="subtitle">Bentley</span> <span class="title">Bentley Flying
                                    Spur</span> </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="#0" class="grid-con">
                            <span class="arrow"><i class="ti-arrow-top-right"></i></span>
                            <div class="text"> <span class="subtitle">Bugatti</span> <span class="title">Bugatti Mistral
                                    W16</span> </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="item"> <img
                                src="img/services/car-insurance-tablet-black-woman-portrait-with-motor-evaluation-inspection-from-hire-road-trip-digital-accident-report-auto-search-outdoor-w.avif"
                                class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                        ...
                        <div class="item"> <img src="img/services/stylish-black-woman-car-salon_1157-21421.avif"
                                class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
    ...
    <section class="cars1 section-padding">
        <div class="container">
            ...
            <div class="cars1-carousel owl-theme owl-carousel">
                ...
                <div class="item">
                    <div class="img"> <img src="img/slider/1african-american-business-man-car_1303-9853.avif" alt="">
                    </div>
                    <div class="con opacity-1">
                        <div class="row">
                            <div class="col-md-7">
                ...
                <div class="item">
                    <div class="img"> <img
                            src="img/slider/1car-insurance-tablet-black-woman-portrait-with-motor-evaluation-inspection-from-hire-road-trip-digital-accident-report-auto-search-outdoor-w.avif"
                            alt=""> </div>
                    <div class="con opacity-1">
                        <div class="row">
                            <div class="col-md-7">

...
<body>
    ...
    <section id="home" data-scroll-index="0" class="slider-grid-bg valign">
        <!-- The opacity on the image is made with "data-overlay-dark="number". You can change it using the numbers 0-9. -->
        <div style="background-image: url('img/slider/25.jpg')" class="grid-img grid-img-active" data-overlay-dark="4"></div>
        <div style="background-image: url('img/slider/2stylish-black-woman-car-salon_1157-21421.avif')" class="grid-img" data-overlay-dark="4"></div>
        <div style="background-image: url('img/slider/27.jpg')" class="grid-img" data-overlay-dark="4"></div>
        <div class="container content">
            <div class="row justify-content-end">
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="#0" class="grid-con grid-con-active"> 
                            <span class="arrow"><i class="ti-arrow-top-right"></i></span>
                            <div class="text"> <span class="subtitle">Aston</span> <span class="title">Aston Martin DBS</span> </div>
                        </a>
                    </div>
                </div>
            </div>
            <div class="row justify-content-end">
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="#0" class="grid-con"> 
                            <span class="arrow"><i class="ti-arrow-top-right"></i></span>
                            <div class="text"> <span class="subtitle">Bentley</span> <span class="title">Bentley Flying Spur</span> </div>
                        </a>
                    </div>
                </div>
            </div>
            <div class="row justify-content-end">
                <div class="col-lg-4 col-md-6">
                    <div class="item">
                        <a href="#0" class="grid-con"> 
                            <span class="arrow"><i class="ti-arrow-top-right"></i></span>
                            <div class="text"> <span class="subtitle">Bugatti</span> <span class="title">Bugatti Mistral W16</span> </div>
                        </a>
                    </div>
                </div>
            </div>

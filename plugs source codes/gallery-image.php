                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu dropdown"> <a class="dropdown-item active dropdown-toggle"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="gallery-image.html" class="dropdown-item active"><span>Image Gallery
                                                Grid</span></a></li>
        ...
        <div class="container">
            ...
            <div class="row gallery-items">
                <div class="col-lg-4 col-md-6 single-item luxurycars mb-15">
                    <a href="img/gallery/african-american-business-man-car_1303-9853.avif" title=""
                        class="gallery-masonry-item-img-link img-zoom">
                        <div class="gallery-box">
                            <div class="gallery-img"> <img
                                    src="img/gallery/african-american-business-man-car_1303-9853.avif"
                ...
                <div class="col-lg-4 col-md-6 single-item luxurycars mb-15">
                    <a href="img/gallery/9.jpg" title="" class="gallery-masonry-item-img-link img-zoom">
                        <div class="gallery-box">
                            <div class="gallery-img"> <img src="img/gallery/9.jpg" class="img-fluid mx-auto d-block"
                                    alt=""> </div>
                            <div class="bottom-fade"></div>
                            <div class="gallery-detail">

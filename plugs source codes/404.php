                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="404.php" class="dropdown-item active"><span>404 Page</span></a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h6 class="fade-in-text">404 Page</h6>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-12 text-center">
                    ...
                    <div class="search-form">
                        <form method="post" action="https://duruthemes.com/demo/html/Carnex/dark/index.php">

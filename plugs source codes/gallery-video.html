                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="gallery-video.html" class="dropdown-item active"><span>Video Gallery</span></a>
                            </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h6 class="fade-in-text">Videos</h6>
                        <h1>Video Gallery</h1>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 mb-30">
                    <div class="item"> <img src="img/gallery/1.jpg">
                ...
                <div class="col-lg-4 col-md-12 mb-30">
                    <div class="item"> <img src="img/gallery/2.jpg" class="img-fluid" alt="">
                        <div class="curv-butn icon-bg">
                            <a href="https://youtu.be/1LxcTt1adfY" class="vid">
                                <div class="icon"> <i class="ti-control-play"></i> </div>
                            </a>
                ...
                <div class="col-lg-4 col-md-12 mb-30">
                    <div class="item"> <img src="img/gallery/3.jpg" class="img-fluid" alt="">
                        <div class="curv-butn icon-bg">
                            <a href="https://youtu.be/1LxcTt1adfY" class="vid">
                                <div class="icon"> <i class="ti-control-play"></i> </div>
                            </a>
                ...
                <div class="col-lg-6 col-md-12 mb-30">
                    <div class="item"> <img src="img/gallery/7.jpg" class="img-fluid" alt="">
                        <div class="curv-butn icon-bg">
                            <a href="https://youtu.be/1LxcTt1adfY" class="vid">
                                <div class="icon"> <i class="ti-control-play"></i> </div>
                            </a>
                ...
                <div class="col-lg-6 col-md-12 mb-30">
                    <div class="item"> <img src="img/gallery/5.jpg" class="img-fluid" alt="">
                        <div class="curv-butn icon-bg">
                            <a href="https://youtu.be/1LxcTt1adfY" class="vid">
                                <div class="icon"> <i class="ti-control-play"></i> </div>
                            </a>

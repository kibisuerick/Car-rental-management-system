    ...
    <section class="banner-header section-padding bg-img" data-overlay-dark="4" data-background="img/slider/3.jpg">
        <div class="v-middle">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="fade-in-text">Carnex</h6>
    ...
    <section class="about section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="content">
                        <div class="section-subtitle">Carnex</div>
                        <div class="section-title">We Are More Than <span>A Car Rental Company</span></div>
                        <p>Experience seamless car rentals with top-tier service and a diverse fleet tailored to your
                            needs. Whether you're seeking luxury or economy, we ensure comfort, reliability, and
                            affordability in every ride. Book with confidence and drive with ease.</p>
                        <p class="mb-30">🚗💨</p>
                ...
                <div class="col-md-5 offset-md-1">
                    <div class="item">
                        <img src="img/happy-woman-showing-car-keys_274689-10444.avif" class="img-fluid" alt="">
    ...
    <section class="team section-padding">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item"> <img src="img/team/young-black-businessman-auto-salon-car-sale-rent-concept_146671-18401.avif"
                                class="img-fluid" alt="">
                        ...
                        <div class="item"> <img
                                src="img/team/happy-african-american-businesswoman-working-touchpad-office_637285-12961.avif"
                                class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="info">
                                <div class="butn icon-bg">

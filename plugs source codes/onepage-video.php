...
<body>
        ...
        <div class="video-fullscreen-wrap">
            ...
            <div class="video-fullscreen-video" data-overlay-dark="2">
                <video playsinline="" autoplay="" loop="" muted="">
                    <source src="https://duruthemes.com/demo/html/Carnex/video.mp4" type="video/mp4" autoplay="" loop="" muted="">
                    <source src="https://duruthemes.com/demo/html/Carnex/video.webm" type="video/webm" autoplay="" loop="" muted="">
                </video>
            </div>
            <div class="v-middle">
                <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item"> <img src="img/services/african-american-business-man-car_1303-9853.avif"
                                class="img-fluid" alt="">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="details"> <span><i class="omfi-door"></i> 4 Seats</span> <span><i
                                            ...
                                            class="omfi-luggage"></i> 2 Bags</span> <span><i class="omfi-age"></i> Age
                                        25</span> </div>
                            </div>
                            <div class="col-md-5">
                                <div class="book">
                    ...
                    <div class="con opacity-1">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="details"> <span><i class="omfi-door"></i> 4 Seats</span> <span><i
                                            class="omfi-transmission"></i> Auto</span> <span><i
                                            class="omfi-luggage"></i> 4 Bags</span> <span><i class="omfi-age"></i> Age
                                        25</span></div>
                            </div>
                            <div class="col-md-5">
                                <div class="book">
                    ...
                    <div class="con opacity-1">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="details"> <span><i class="omfi-door"></i> 4 Seats</span> <span><i
                                            class="omfi-transmission"></i> Auto</span> <span><i
                                            class="omfi-luggage"></i> 3 Bags</span> <span><i class="omfi-age"></i> Age
                                        25</span></div>
                            </div>
                            <div class="col-md-5">
                                <div class="book">
    ...
    <div class="line-vr-section"></div>
    <!-- Car Category -->
    <section id="car-types" data-scroll-index="4" class="car-types4 section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mb-30">
            ...
            <div class="row">
                ...
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="item mb-15">
                        <div class="img"> <img src="img/cars/0stylish-black-woman-car-salon_1157-21421.avif" class="img-fluid" alt=""> </div>
                        <div class="info">
                    ...
                    <div class="item mb-15">
                        <div class="img"> <img src="img/cars/0african-american-business-man-car_1303-9853.avif" class="img-fluid" alt=""> </div>
                        <div class="info">
                            <h2 class="title">Luxury Cars</h2>
                            <p class="subtitle">Car Types</p>
                        </div>
                    ...
                    <div class="item mb-15">
                        <div class="img"> <img src="img/cars/0car-insurance-tablet-black-woman-portrait-with-motor-evaluation-inspection-from-hire-road-trip-digital-accident-report-auto-search-outdoor-w.avif" class="img-fluid" alt=""> </div>
                        <div class="info">
                            <h2 class="title">Sport Cars</h2>
                            <p class="subtitle">Car Types</p>
                        </div>

            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h6 class="fade-in-text">Get in touch</h6>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 animate-box" data-animate-effect="fadeInUp">
                    <div class="item"> <span class="icon omfi-envelope"></span>
                        <h5>Email us</h5>
                        <p>florence.mwaiflorence384@gmail.com</p> <i class="numb omfi-envelope"></i>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 animate-box" data-animate-effect="fadeInUp">
                    <div class="item"> <span class="icon omfi-location"></span>
                        <h5>Our address</h5>
                        <p>Gataka Rd, Nairobi</p> <i class="numb omfi-location"></i>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 animate-box" data-animate-effect="fadeInUp">
                ...
                <div class="col-lg-3 col-md-6 animate-box" data-animate-effect="fadeInUp">
                    <div class="item active"> <span class="icon omfi-phone"></span>
                        <h5>Call us</h5>
                        <p>+254 797 901 036</p> <i class="numb omfi-phone"></i>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 mb-30">
                    <div class="form-box">
                        ...
                        <form method="post" class="contact__form"
                            action="https://duruthemes.com/demo/html/Carnex/dark/mail.html">
                            <!-- form message -->
                            <div class="row">
                                <div class="col-12">
                ...
                <div class="col-lg-5 offset-lg-1 col-md-12">
                    ...
                    <div class="google-map">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.655211500642!2d36.73507467496574!3d-1.3835083986034125!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f0456a03bc61b%3A0x8347761ff51c109f!2sGataka%20Rd%2C%20Nairobi!5e0!3m2!1sen!2ske!4v1742664176072!5m2!1sen!2ske"

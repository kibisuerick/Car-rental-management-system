...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                            data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Services <i
                                class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="services.html" class="dropdown-item active"><span>Services 01</span></a></li>
    ...
    <section class="banner-header section-padding bg-img" data-overlay-dark="6"
        data-background="img/slider/1african-american-business-man-car_1303-9853.avif">
        <div class="v-middle">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h6 class="fade-in-text">What We Do</h6>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-45">
                    <div class="item">
                        <div class="text">
                            ...
                            <p>Effortlessly manage your corporate travel with our premium car rental services. Whether
                                for executive meetings, corporate events, or employee transportation, we offer a fleet
                                of high-end vehicles to meet your business needs. Enjoy flexibility, reliability, and
                ...
                <div class="col-lg-4 col-md-6 mb-45">
                    <div class="item">
                        <div class="text">
                            ...
                            <p>Sit back and relax while our professional chauffeurs take you to your destination safely
                                and comfortably. Our car rental with driver service is perfect for business trips,
                                special occasions, or city tours. Experience seamless transportation with experienced
                                drivers who prioritize your comfort and punctuality.</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">
                                <a href="service-details.html">
                    ...
                    <div class="item">
                        <div class="text">
                            ...
                            <p>Start and end your journey stress-free with our airport transfer service. We provide
                                ...
                                traveling for business or leisure, our fleet is available 24/7 to provide a smooth and
                ...
                <div class="col-lg-4 col-md-6 mb-45">
                    <div class="item">
                        <div class="text">
                            <h5>Fleet Leasing</h5>
                            <p>Optimize your business operations with our flexible fleet leasing solutions. Whether you
                                need a single vehicle or an entire fleet, we offer cost-effective, well-maintained cars
                                tailored to your corporate or personal needs. Enjoy hassle-free leasing with full
                ...
                <div class="col-lg-4 col-md-6 mb-45">
                    <div class="item">
                        <div class="text">
                            <h5>VIP Transfer</h5>
                            <p>Experience luxury and exclusivity with our VIP transfer service. Designed for executives,
                                celebrities, and high-profile individuals, we provide premium vehicles with professional
                                chauffeurs for a smooth and stylish ride. Travel in comfort, privacy, and security.</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">
                                <a href="service-details.html">
                ...
                <div class="col-lg-4 col-md-6 mb-45">
                    <div class="item">
                        <div class="text">
                            ...
                            <p>Get personalized and comfortable travel with our private transfer services. Whether for
                                business or leisure, enjoy door-to-door service with well-maintained vehicles and
                                experienced drivers. Avoid the hassle of public transport and ride in peace.</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">
                                <a href="service-details.html">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 text-center mb-30">
                    ...
                    <div class="section-title white">Other Services</div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="item">
                        <div class="text">
                            ...
                            <p>Need a car for a short-term trip? Our daily car rental service offers flexible and
                                affordable solutions. Choose from a variety of vehicles and enjoy the convenience of
                                reliable transportation, whether for business, leisure, or errands.</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="item">
                        <div class="text">
                            ...
                            <p>For extended use, our monthly car rental service provides cost-effective options with no
                                long-term commitments. Enjoy unlimited mileage plans, routine maintenance, and a
                                hassle-free experience. Ideal for professionals, long-term travelers, and business
                                needs.</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">
                ...
                <div class="col-lg-4 col-md-6 mb-30">
                    <div class="item">
                        <div class="text">
                            ...
                            <p>Lock in a car for an entire year with our annual rental plans. Enjoy exclusive discounts,
                                priority service, and dedicated vehicle maintenance. Perfect for corporate clients and
                                individuals seeking stability in transportation.</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">

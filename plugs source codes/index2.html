...
<body>
    ...
    <!-- Parallax Image -->
    <section class="parallax-header section-padding valign bg-img bg-fixed" data-overlay-dark="5"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-theme owl-carousel">
                        ...
                        <div class="item"> <img src="img/blog/11.jpg" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="item mb-15">
                            <div class="img"> <img src="img/cars/01.jpg" class="img-fluid" alt=""> </div>
                            <div class="info">
                        ...
                        <div class="item mb-15">
                            <div class="img"> <img src="img/cars/04.jpg" class="img-fluid" alt=""> </div>
                            <div class="info">
                                <h2 class="title">Sport Cars</h2>
                                <p class="subtitle">Car Types</p>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        ...
                        <p class="mb-30">Enjoy swift bookings, easy online payments and upload documents in advance to
                            speed up your pick-up.</p>
                        <a href="#0" class="button-3 mb-20 mr-10">Apple Store <span
                                class="fa-brands fa-apple"></span></a>
                        <a href="#0" class="button-3 mb-20">Google Play <span
                                class="fa-brands fa-google-play"></span></a>
                    </div>

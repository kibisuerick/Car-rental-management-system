                            ...
                            <li class="dropdown-submenu dropdown"> <a class="dropdown-item active dropdown-toggle"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="gallery-image.html" class="dropdown-item"><span>Image Gallery
                                                Grid</span></a></li>
                                    <li><a href="gallery-image2.html" class="dropdown-item active"><span>Image Gallery
                                                Masonry</span></a></li>
                                </ul>
                            </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h6 class="fade-in-text">Our Portfolio</h6>
                        <h1>Image Gallery</h1>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row gallery-items" data-masonry='{"percentPosition": true }'>
                <div class="col-lg-4 col-md-6 single-item luxurycars mb-15">
                    <a href="img/blog/8.jpg" title="" class="gallery-masonry-item-img-link img-zoom">
                        <div class="gallery-box">
                            <div class="gallery-img"> <img src="img/blog/8.jpg" class="img-fluid mx-auto d-block"
                                    alt=""> </div>
                ...
                <div class="col-lg-4 col-md-6 single-item suv mb-15">
                    <a href="img/gallery/car-insurance-tablet-black-woman-portrait-with-motor-evaluation-inspection-from-hire-road-trip-digital-accident-report-auto-search-outdoor-w.avif"
                        title="" class="gallery-masonry-item-img-link img-zoom">
                        <div class="gallery-box">
                            <div class="gallery-img"> <img
                                    src="img/gallery/car-insurance-tablet-black-woman-portrait-with-motor-evaluation-inspection-from-hire-road-trip-digital-accident-report-auto-search-outdoor-w.avif"
                ...
                <div class="col-lg-4 col-md-6 single-item suv mb-15">
                    <a href="img/blog/9.jpg" title="" class="gallery-masonry-item-img-link img-zoom">
                        <div class="gallery-box">
                            <div class="gallery-img"> <img src="img/blog/9.jpg" class="img-fluid mx-auto d-block"
                                    alt=""> </div>
                            <div class="bottom-fade"></div>
                            <div class="gallery-detail">
                ...
                <div class="col-lg-4 col-md-6 single-item luxurycars mb-15">
                    <a href="img/gallery/stylish-black-woman-car-salon_1157-21421.avif" title=""
                        class="gallery-masonry-item-img-link img-zoom">
                        <div class="gallery-box">
                            <div class="gallery-img"> <img
                                    src="img/gallery/stylish-black-woman-car-salon_1157-21421.avif"
                                    class="img-fluid mx-auto d-block" alt=""> </div>
                            <div class="bottom-fade"></div>
                            <div class="gallery-detail">
                ...
                <div class="col-lg-4 col-md-6 single-item luxurycars mb-15">
                    <a href="img/blog/7.jpg" title="" class="gallery-masonry-item-img-link img-zoom">
                        <div class="gallery-box">
                            <div class="gallery-img"> <img src="img/blog/7.jpg" class="img-fluid mx-auto d-block"
                                    alt=""> </div>
                            <div class="bottom-fade"></div>
                            <div class="gallery-detail">
                ...
                <div class="col-lg-4 col-md-6 single-item suv mb-15">
                    <a href="img/gallery/8.jpg" title="" class="gallery-masonry-item-img-link img-zoom">
                        <div class="gallery-box">
                            <div class="gallery-img"> <img src="img/gallery/8.jpg" class="img-fluid mx-auto d-block"
                                    alt=""> </div>
                            <div class="bottom-fade"></div>
                            <div class="gallery-detail">
                                <h4>AUDI Q8</h4>

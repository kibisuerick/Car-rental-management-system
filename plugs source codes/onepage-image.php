...
<body>
    ...
    <!-- Parallax Image -->
    <section id="home" data-scroll-index="0" class="parallax-header valign bg-img bg-fixed" data-overlay-dark="5" data-background="img/slider/african-american-business-man-car_1303-9853.avif">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <h6 class="fade-in-text">* Premium</h6>
                    <h1>Rental Car</h1>
                    <h5>Bugatti Mistral W16 <span>kes 95000 <i>/ day</i></span></h5> 
    ...
    <!-- Car Types -->
    <section class="car-types2 mt--80">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <a href="car-details.php"> <span class="flaticon-car-of-hatchback-model"></span>
                                <h6 class="fade-in-text">Hatchback</h6>
                            </a>
                        ...
                        <div class="item">
                            <a href="car-details.php"> <span class="flaticon-sedan-car-model"></span>
                                <h6 class="fade-in-text">Sedan</h6>
                            </a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-1 col-md-12">
                    <div class="item"> <img src="img/happy-woman-showing-car-keys_274689-10444.avif" class="img-fluid" alt="">
    ...
    <!-- Services 1 -->
    <section id="services" data-scroll-index="2" class="services1 section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="text">
                            ...
                            <p>Effortlessly manage your corporate travel with our premium car rental services. Whether for executive meetings, corporate events, or employee transportation, we offer a fleet of high-end vehicles to meet your business needs. Enjoy flexibility, reliability, and professionalism with every ride.</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">
                    ...
                    <div class="item">
                        <div class="text">
                            ...
                            <p>Sit back and relax while our professional chauffeurs take you to your destination safely and comfortably. Our car rental with driver service is perfect for business trips, special occasions, or city tours. Experience seamless transportation with experienced drivers who prioritize your comfort and punctuality.</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">
                                <a href="service-details.php">
                    ...
                    <div class="item">
                        <div class="text">
                            ...
                            <p>Start and end your journey stress-free with our airport transfer service. We provide timely pickups and drop-offs, ensuring you reach your destination on time. Whether traveling for business or leisure, our fleet is available 24/7 to provide a smooth and comfortable transfer experience.
</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">
                    ...
                    <div class="item">
                        <div class="text">
                            <h5>Fleet Leasing</h5>
                            <p>Optimize your business operations with our flexible fleet leasing solutions. Whether you need a single vehicle or an entire fleet, we offer cost-effective, well-maintained cars tailored to your corporate or personal needs. Enjoy hassle-free leasing with full support and maintenance.</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">
                                <a href="service-details.php">
                    ...
                    <div class="item">
                        <div class="text">
                            <h5>VIP Transfer</h5>
                            <p>Experience luxury and exclusivity with our VIP transfer service. Designed for executives, celebrities, and high-profile individuals, we provide premium vehicles with professional chauffeurs for a smooth and stylish ride. Travel in comfort, privacy, and security.</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">
                                <a href="service-details.php">
                    ...
                    <div class="item">
                        <div class="text">
                            ...
                            <p>Get personalized and comfortable travel with our private transfer services. Whether for business or leisure, enjoy door-to-door service with well-maintained vehicles and experienced drivers. Avoid the hassle of public transport and ride in peace.</p>
                        </div>
                        <div class="numb">
                            <div class="numb-curv">
                                <a href="service-details.php">
    ...
    <!-- Cars 2 -->
    <section id="cars" data-scroll-index="3" class="cars2 section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mb-30">
            ...
            <div class="row">
                    ...
                    <div class="owl-theme owl-carousel">
                        <div class="item"> <img src="img/blog/8.jpg" class="img-fluid" alt="">
                            ...
                            <div class="title">
                                ...
                                <div class="details">
                                    ...
                                    <span><i class="omfi-user"></i> Age 25</span>
                                </div>
                            </div>
                            <div class="curv-butn icon-bg">
                        ...
                        <div class="item"> <img src="img/blog/stylish-black-woman-car-salon_1157-21421.avif" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
                        ...
                        <div class="item"> <img src="img/blog/10.jpg" class="img-fluid" alt="">
                            ...
                            <div class="title">
                                <h4>AUDI Q8</h4>
                                <div class="details">
                                    <span><i class="omfi-door"></i> 3 Seats</span>
                                    <span><i class="omfi-transmission"></i> Auto</span>
                                    <span><i class="omfi-luggage"></i> 2 Bags</span>
                                </div>
                            </div>
                        ...
                        <div class="item"> <img src="img/blog/1african-american-business-man-car_1303-9853.avif" class="img-fluid" alt="">
                            <div class="bottom-fade"></div>
                            <div class="title">
    ...
    <div class="line-vr-section"></div>
    <!-- Car Category -->
    <section id="car-types" data-scroll-index="4" class="car-types3 section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mb-30">
            ...
            <div class="row">
                ...
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="text">
                            <h5>Luxury Cars</h5>
                            <p>Lorem ipsum dolor sit amet the in constran adipiscing elit entesque hendrerit elit nisan elacinia in the miss aucton.</p>
                        </div>
                        <div class="icon">
                            <div class="icon-curv">
                                <a href="#"><div class="icon-w"><i class="flaticon-coupe-car icon-show"></i><i class="ti-arrow-top-right icon-hidden"></i></div></a>
                                <div class="shap-left-top">
                                    <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                        <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                                    </svg>
                    ...
                    <div class="item">
                        ...
                        <div class="icon">
                            <div class="icon-curv">
                                <a href="#"><div class="icon-w"><i class="flaticon-sportive-car icon-show"></i><i class="ti-arrow-top-right icon-hidden"></i></div></a>
                                <div class="shap-left-top">
                                    <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                        <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                                    </svg>
                    ...
                    <div class="item">
                        ...
                        <div class="icon">
                            <div class="icon-curv">
                                <a href="#"><div class="icon-w"><i class="flaticon-car-suv icon-show"></i><i class="ti-arrow-top-right icon-hidden"></i></div></a>
                                <div class="shap-left-top">
                                    <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                        <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                                    </svg>
                    ...
                    <div class="item">
                        ...
                        <div class="icon">
                            <div class="icon-curv">
                                <a href="#"><div class="icon-w"><i class="flaticon-cabrio-car icon-show"></i><i class="ti-arrow-top-right icon-hidden"></i></div></a>
                                <div class="shap-left-top">
                                    <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                        <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                                    </svg>
                    ...
                    <div class="item">
                        ...
                        <div class="icon">
                            <div class="icon-curv">
                                <a href="#"><div class="icon-w"><i class="flaticon-car-of-hatchback-model icon-show"></i><i class="ti-arrow-top-right icon-hidden"></i></div></a>
                                <div class="shap-left-top">
                                    <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                        <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                                    </svg>
                    ...
                    <div class="item">
                        ...
                        <div class="icon">
                            <div class="icon-curv">
                                <a href="#"><div class="icon-w"><i class="flaticon-minivan-car icon-show"></i><i class="ti-arrow-top-right icon-hidden"></i></div></a>
                                <div class="shap-left-top">
                                    <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                        <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                                    </svg>
    ...
    <div class="line-vr-section"></div>
    <!-- Process -->
    <section id="process" data-scroll-index="5" class="process section-padding">
        <div class="container">
    ...
    <!-- Video -->
    <section class="video-wrapper video section-padding bg-img bg-fixed" data-overlay-dark="4" data-background="img/slider/african-american-business-man-car_1303-9853.avif">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            ...
                            <div class="text">
                                <p>Reliable and affordable! The car selection is fantastic, and the service was hassle-free from start to finish. A truly five-star experience!</p>
                            </div>
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img src="img/team/satisfied-black-driver-driving-his-car-gesturing-okay-camera_232070-24887.avif" alt=""> </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                            <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                                        </svg>
                        ...
                        <div class="item">
                            ...
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img
                                            src="img/team/african-american-business-man-car_1303-9852.avif"
                                            alt=""> </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg"
                                            class="w-11 h-11">
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                <p>I had an amazing experience with this rental service. The team was professional, the booking was quick, and the car exceeded my expectations. Will definitely rent again!</p>
                            </div>
                            <div class="info mt-30">
                                <div class="img-curv">
                                    <div class="img"> <img src="img/team/stylish-black-woman-car-salon_1157-21421.avif" alt=""> </div>
                                    <div class="shap-left-top">
                                        <svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-11 h-11">
                                            <path d="M11 1.54972e-06L0 0L2.38419e-07 11C1.65973e-07 4.92487 4.92487 1.62217e-06 11 1.54972e-06Z" fill="#1b1b1b"></path>
                                        </svg>
    ...
    <div class="line-vr-section"></div>
    <!-- Blog 1 -->
    <section id="blog" data-scroll-index="6" class="blog1 section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mb-30">
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            ...
                            <div class="wrapper">
                                ...
                                <div class="con">
                                    ...
                                    <div class="text"> <a href="post.php">Documents required for car rental</a> </div> <a href="post.php" class="icon-btn"><i class="ti-arrow-top-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <!--<div class="item">
                        ...
                        <div class="item">
                            ...
                            <div class="wrapper">
                                ...
                                <div class="con">
                                    <div class="category"> <a href="#"><i class="ti-user"></i>Martin C.</a> <a href="#"><i class="ti-comment"></i>5 Comments</a> </div>
                                    <div class="text"> <a href="post.php">Rental cars how to check driving fines?</a> </div> <a href="post.php" class="icon-btn"><i class="ti-arrow-top-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="img"> <img src="img/blog/0stylish-black-woman-car-salon_1157-21421.avif" alt=""> </div>
                            <div class="wrapper">
                                ...
                                <div class="con">
                                    ...
                                    <div class="text"> <a href="post.php">How to Rent a Car at the Airport Terminal?</a> </div> <a href="post.php" class="icon-btn"><i class="ti-arrow-top-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="img"> <img src="img/blog/0african-american-business-man-car_1303-9853.avif" alt=""> </div>
                            <div class="wrapper">
                                ...
                                <div class="con">
                                    ...
                                    <div class="text"> <a href="post.php">Penalties for violating the rules in rental cars</a> </div> <a href="post.php" class="icon-btn"><i class="ti-arrow-top-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="wrapper">
                                ...
                                <div class="con">
                                    ...
                                    <div class="text"> <a href="post.php">How to check a car before renting?</a> </div> <a href="post.php" class="icon-btn"><i class="ti-arrow-top-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
           ...
           <div class="item">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    ...
                    <p class="mb-30">Enjoy swift bookings, easy online payments and upload documents in advance to speed up your pick-up.</p> 
                    <a href="#0" class="button-3 mb-20 mr-10">Apple Store <span class="fa-brands fa-apple"></span></a>
                    <a href="#0" class="button-3 mb-20">Google Play <span class="fa-brands fa-google-play"></span></a>
                </div>
                    ...
                    <div class="col-md-4 widget-area">
                        <div class="widget clearfix">
                            ...
                            <div class="widget-text">
                                <p>Experience seamless car rentals with Carnex. Whether you need a ride for business or leisure, we offer reliable, well-maintained vehicles at unbeatable rates. Drive with confidence, wherever your journey takes you!</p>

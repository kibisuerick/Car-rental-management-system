                            ...
                            <li class="dropdown-submenu dropdown"> <a class="dropdown-item active dropdown-toggle"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="service-details2.html" class="dropdown-item"><span>Let's serve
                                                you</span></a></li>
                                    <li><a href="service-details3.html" class="dropdown-item active"><span>Service
                                                Details 03</span></a></li>
                                    <li><a href="service-details4.html" class="dropdown-item"><span>Service Details
                                                04</span></a></li>-->
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="row mb-60">
                        <div class="col-md-12">
                            ...
                            <pExperience luxury and exclusivity with our VIP Transfer services. Whether you're heading
                                to a corporate event, a special occasion, or simply desire premium comfort, we provide
                                high-end vehicles with professional chauffeurs to ensure a seamless journey.<h2
                                class="animated-text">Options for VIP Transfers</h2><br><b>Luxury Chauffeur Service
                                </b>- Travel in style with our executive fleet and professional drivers.<b>Corporate
                                    Transfers </b>- Reliable, punctual, and elegant transport for business
                                executives.<b>Event Transfers</b>- Arrive in sophistication at weddings, red carpet
                                events, and VIP gatherings.</p>
                                <h3>Options for VIP Transfers</h3>
                                <p class="mb-30">Lorem pretium fermentum quam, sit amet cursus ante sollicitudin velen
                                    morbi consesua rana the miss sustion consation porttitor orci sit amet iaculis
                                    nisan. Lorem pretium fermentum quam sit amet cursus ante solicitune velention fermen
                                    morbinetion consesua the risus the porttiton.</p>
                                ...
                                <p class="mb-30">Lorem pretium fermentum quam, sit amet cursus ante sollicitudin velen
                                    morbi consesua the miss sustion consation miss orcisition amet iaculis nisan lorem
                                    pretium fermentum quam sit fermen.</p>
                            ...
                            <ul class="accordion-box clearfix">
                                <li class="accordion block">
                                    ...
                                    <div class="acc-content">
                                        <div class="content">
                                            <div class="text">Lorem pretium fermentum quam, sit amet cursus ante
                                                sollicitudin velen morbi consesua rana the miss sustion consation
                                                porttitor orci sit amet iaculis nisan. Lorem pretium fermentum quam sit
                                                amet cursus ante solicitune velention fermen morbinetion consesua the
                                                risus the porttiton.</div>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block">

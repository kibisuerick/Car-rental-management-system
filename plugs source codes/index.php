...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="index.php" class="dropdown-item active"><span>Slider 01</span></a></li>
    ...
    <header class="header slider-fade">
        <div class="owl-carousel owl-theme">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 mb-30">
                                <div class="v-middle">
                                    ...
                                    <h1>Rental Car</h1>
                                    <h5>Bentley Bentayga <span>Kes 65,000 <i>/ day</i></span></h5> <a href="#0"
                                        class="button-1 mt-15 mb-15">View Details <span
                                            class="ti-arrow-top-right"></span></a> <a href="#" data-scroll-nav="1"
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 mb-30">
                                <div class="v-middle">
                                    <h6 class="fade-in-text">* Premium</h6>
                                    <h1>Rental Car</h1>
                                    <h5>Rolls Royce Cullinan <span>Kes 102,000 <i>/ day</i></span></h5> <a href="#0"
                                        class="button-1 mt-15 mb-15">View Details <span
                                            class="ti-arrow-top-right"></span></a> <a href="#" data-scroll-nav="1"
                                        class="button-2 mt-15 mb-15">Rent Now <span
                                            class="ti-arrow-top-right"></span></a>
            ...
            <div class="item bg-img" data-overlay-dark="5"
                data-background="img/slider/1car-insurance-tablet-black-woman-portrait-with-motor-evaluation-inspection-from-hire-road-trip-digital-accident-report-auto-search-outdoor-w.avif">
                <div class="v-middle caption">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 mb-30">
                                <div class="v-middle">
                                    <h6 class="fade-in-text">* Premium</h6>
                                    <h1>Rental Car</h1>
                                    <h5>Audi RS7 Sportback <span>kes 50000 <i>/ day</i></span></h5> <a href="#0"
                                        class="button-1 mt-15 mb-15">View Details <span
                                            class="ti-arrow-top-right"></span></a> <a href="#" data-scroll-nav="1"
                                        class="button-2 mt-15 mb-15">Rent Now <span
                                            class="ti-arrow-top-right"></span></a>

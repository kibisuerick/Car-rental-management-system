...
<head>
    ...
    <style>
        ...
        /* Slide-up animation for "Latest News" */
        .animated-text {
            opacity: 0;
...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                            data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Blog <i
                                class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="blog.php" class="dropdown-item active"><span>Blog Grid</span></a></li>
    ...
    <!-- Header Banner -->
    <section class="banner-header section-padding bg-img" data-overlay-dark="6" data-background="img/slider/2.jpg">
        <div class="v-middle">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h6 class="fade-in-text">Blog & News</h6>
                        <h1 class="animated-text">Latest News</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="blog1 section-padding">
        <div class="container">
            <div class="row">
                    ...
                    <div class="item">
                        ...
                        <div class="wrapper">
                            ...
                            <div class="con">
                                ...
                                <div class="text"> <a href="post.php">Documents required for car rental</a> </div> <a
                                    href="post.php" class="icon-btn"><i class="ti-arrow-top-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="wrapper">
                            ...
                            <div class="con">
                                <div class="category"> <a href="#"><i class="ti-user"></i>Martin C.</a> <a href="#"><i
                                            class="ti-comment"></i>5 Comments</a> </div>
                                <div class="text"> <a href="post.php">Rental cost of sport and other cars</a> </div> <a
                                    href="post.php" class="icon-btn"><i class="ti-arrow-top-right"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="wrapper">
                            ...
                            <div class="con">
                                <div class="category"> <a href="#"><i class="ti-user"></i>Arya T.</a> <a href="#"><i
                                            class="ti-comment"></i>5 Comments</a> </div>
                                <div class="text"> <a href="post.php">How to Rent a Car at the Airport Terminal?</a>
                                </div> <a href="post.php" class="icon-btn"><i class="ti-arrow-top-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-45">
                    <div class="item">
                        <div class="img"> <img src="img/blog/01.jpg" alt="">
                        </div>
                        <div class="wrapper">
                        ...
                        <div class="wrapper">
                            ...
                            <div class="con">
                                <div class="category"> <a href="#"><i class="ti-user"></i>Daniel K.</a> <a href="#"><i
                                            class="ti-comment"></i>5 Comments</a> </div>
                                <div class="text"> <a href="post.php">How to check a car before renting?</a> </div> <a
                                    href="post.php" class="icon-btn"><i class="ti-arrow-top-right"></i></a>
                            </div>
                        </div>
                    </div>

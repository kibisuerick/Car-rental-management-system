                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu dropdown"> <a class="dropdown-item active dropdown-toggle"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="car-details.html" class="dropdown-item active"><span>Car Details
                                                01</span></a></li>
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="row mb-60">
                        <div class="col-md-12">
                            ...
                            <p class="mb-30">Lorem pretium fermentum quam, sit amet cursus ante sollicitudin velen morbi
                                ...
                                fermentum quam sit amet cursus ante sollicitudin velen fermen orbinetion consesua the
                    ...
                    <div class="row gallery-items mb-60">
                        <div class="col-md-6 gallery-masonry-wrapper single-item cardio">
                            <a href="img/slider/11b.jpg" title="" class="gallery-masonry-item-img-link img-zoom">
                                <div class="gallery-box">
                                    <div class="gallery-img"> <img src="img/slider/11b.jpg"
                        ...
                        <div class="col-md-6 gallery-masonry-wrapper single-item crossfit">
                            <a href="img/slider/11a.jpg" title="" class="gallery-masonry-item-img-link img-zoom">
                                <div class="gallery-box">
                                    <div class="gallery-img"> <img src="img/slider/11a.jpg"
                                            class="img-fluid mx-auto d-block" alt=""> </div>
                                    <div class="gallery-masonry-item-img"></div>
                                </div>
                            </a>

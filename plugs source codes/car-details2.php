                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu dropdown"> <a class="dropdown-item active dropdown-toggle"
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="car-details.php" class="dropdown-item"><span>Car Details 01</span></a>
                                    </li>
                                    <li><a href="car-details2.php" class="dropdown-item active"><span>Car Details
                                                02</span></a></li>
                                    <li><a href="car-details3.php" class="dropdown-item"><span>Car Details
                                                03</span></a></li>
                                    <li><a href="car-details4.php" class="dropdown-item"><span>Car Details
                                                04</span></a></li>
                                </ul>
                            </li>
                        </ul>

                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu dropdown"> <a class="dropdown-item active dropdown-toggle"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="car-details2.html" class="dropdown-item"><span>Car Details
                                                02</span></a></li>
                                    <li><a href="car-details3.html" class="dropdown-item active"><span>Car Details
                                                03</span></a></li>
        ...
        <div class="video-fullscreen-wrap">
            ...
            <div class="video-fullscreen-video" data-overlay-dark="2">
                <video playsinline="" autoplay="" loop="" muted="">
                    <source src="https://duruthemes.com/demo/html/Carnex/video.mp4" type="video/mp4" autoplay="" loop=""
                        muted="">
                    <source src="https://duruthemes.com/demo/html/Carnex/video.webm" type="video/webm" autoplay=""
                        loop="" muted="">
                </video>
            </div>
        </div>

                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-submenu dropdown"> <a class="dropdown-item active dropdown-toggle"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="cars3.php" class="dropdown-item active"><span>Car Grid 03</span></a></li>
                                </ul>
                            </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h6 class="fade-in-text">Select Your Car</h6>
                    ...
                    <div class="item">
                        ...
                        <div class="info">
                            ...
                            <div class="details"> <span><i class="omfi-door"></i> 2 Seats</span> <span><i
                                        class="omfi-transmission"></i> Auto</span> <span><i class="omfi-age"></i> Age
                                    25</span> </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-60">
                    <div class="item">
                        ...
                        <a href="post.php" class="img"> <img
                                src="img/blog/stylish-black-woman-car-salon_1157-21421.avif" alt="" class="img-fluid">
                            <div class="bottom-fade"></div>
                            <div class="arrow"> <i class="ti-arrow-right"></i> </div>
                        </a>
                        <div class="info">
            ...
            <!--<div class="row">
                <div class="col-md-12 text-center">
                    <ul class="pagination-wrap">
                        <li><a href="blog2.php#"><i class="ti-angle-left"></i></a></li>
                        <li><a href="blog2.php#">1</a></li>
                        <li><a href="blog2.php#" class="active">2</a></li>
                        <li><a href="blog2.php#">3</a></li>
                        <li><a href="blog2.php#"><i class="ti-angle-right"></i></a></li>
                    </ul>
                </div>
            </div>-->
        </div>

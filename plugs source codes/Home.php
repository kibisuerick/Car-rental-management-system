                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="Home.php" class="dropdown-item active"><span>Main page</span></a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-12">
                                <div class="caption">
                                    ...
                                    <h5>Reserve now and get the best offer <span>Kes 90,000 <i>/ day</i></span></h5>
                            ...
                            <div class="col-lg-4 offset-lg-1 col-md-12">
                                <div class="car-features">
                                    <div class="wrapp">
                                        ...
                                        <div class="features"><span><i class="omfi-transmission"></i>
                                                Transmission</span>
                                            <p>Auto</p>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-12">
                                <div class="caption">
                                    ...
                                    <h5>Reserve now and get the best offer <span>Kes 65,000 <i>/ day</i></span></h5>
                                    <a href="#0" class="button-1 mt-15 mb-15">View Details <span
                                            class="ti-arrow-top-right"></span></a>
                                    <a href="#" data-scroll-nav="1" class="button-2 mt-15 mb-15">Rent Now <span
                                            class="ti-arrow-top-right"></span></a>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-12">
                                <div class="caption">
                                    ...
                                    <h5>Reserve now and get the best offer <span>Kes 102,000 <i>/ day</i></span></h5>
                                    <a href="#0" class="button-1 mt-15 mb-15">View Details <span
                                            class="ti-arrow-top-right"></span></a>
                                    <a href="#" data-scroll-nav="1" class="button-2 mt-15 mb-15">Rent Now <span
                                            class="ti-arrow-top-right"></span></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="book">
                                    ...
                                    <div><span class="price">kes 50,000</span><span>/day</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="con opacity-1">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="book">
                                    <div><a href="car-details.php" class="btn"><span>Details</span></a></div>
                                    <div><span class="price">kes 57,600</span><span>/day</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="con opacity-1">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="book">
                                    <div><a href="car-details.php" class="btn"><span>Details</span></a></div>
                                    <div><span class="price">kes 76,800</span><span>/day</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="con opacity-1">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="book">
                                    <div><a href="car-details.php" class="btn"><span>Details</span></a></div>
                                    <div><span class="price">kes 110,000</span><span>/day</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="con opacity-1">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="book">
                                    <div><a href="car-details.php" class="btn"><span>Details</span></a></div>
                                    <div><span class="price">kes 64,000</span><span>/day</span></div>
                                </div>
                            </div>
                        </div>
                    </div>

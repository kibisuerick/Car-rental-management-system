...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="blog3.php" class="dropdown-item active"><span>Blog List</span></a></li>
    ...
    <!-- Header Banner -->
    <section class="banner-header section-padding bg-img" data-overlay-dark="6" data-background="img/slider/10.jpg">
        <div class="v-middle">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h6 class="fade-in-text">Blog & News</h6>
                        <h1>Latest News</h1>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.php"> <img src="img/slider/5.jpg" alt=""> </a>
                                </div>
                                <div class="post-cont"> <span class="category"><a href="blog.php">Rent A Car</a></span>
                                    <span class="calendar"><a href="blog.php">27 Apr, 2025</a></span>
                                    <h5><a href="post.php">Documents required for car rental</a></h5>
                                    <p>Lorem ipsum potenti fringilla pretium ipsum non blandit vivamus eget nisi non mi
                                        iaculis iaculis imperie quiseros sevin elentesque habitant morbi tristique
                                        senectus et netus et malesuada the fames ac turpis enesta mauris suscipit mis
                                        nec est farmen.</p> <a href="post.php" class="button-1">Read More</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.php"> <img
                                            src="img/slider/car-insurance-tablet-black-woman-portrait-with-motor-evaluation-inspection-from-hire-road-trip-digital-accident-report-auto-search-outdoor-w.avif"
                                            alt=""> </a>
                                </div>
                                <div class="post-cont"> <span class="category"><a href="blog.php">Cars</a></span> <span
                                        class="calendar"><a href="blog.php">25 Apr, 2025</a></span>
                                    <h5><a href="post.php">Rental cost of sport and other cars</a></h5>
                                    <p>Lorem ipsum potenti fringilla pretium ipsum non blandit vivamus eget nisi non mi
                                        iaculis iaculis imperie quiseros sevin elentesque habitant morbi tristique
                                        senectus et netus et malesuada the fames ac turpis enesta mauris suscipit mis
                                        nec est farmen.</p> <a href="post.php" class="button-1">Read More</a>
                        ...
                        <div class="col-md-12">
                            <div class="item">
                                <div class="post-img">
                                    <a href="post.php"> <img src="img/slider/3.jpg" alt=""> </a>
                                </div>
                                <div class="post-cont"> <span class="category"><a href="blog.php">Battery</a></span>
                                    <span class="calendar"><a href="blog.php">23 Apr, 2025</a></span>
                                    <h5><a href="post.php">Rental cars how to check driving fines?</a></h5>
                                    <p>Lorem ipsum potenti fringilla pretium ipsum non blandit vivamus eget nisi non mi
                                        iaculis iaculis imperie quiseros sevin elentesque habitant morbi tristique
                                        senectus et netus et malesuada the fames ac turpis enesta mauris suscipit mis
                                        nec est farmen.</p> <a href="post.php" class="button-1">Read More</a>
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-30 mb-30">
                            <ul class="pagination-wrap">
                                <li><a href="blog3.php"><i class="ti-angle-left"></i></a></li>
                                <li><a href="blog3.php">1</a></li>
                                <li><a href="blog3.php" class="active">2</a></li>
                                <li><a href="blog3.php">3</a></li>
                                <li><a href="blog3.php"><i class="ti-angle-right"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12">
                    <div class="blog3-sidebar row">
                        ...
                        <div class="col-md-12">
                            <div class="widget">
                                <div class="widget-title">
                                    <h6 class="fade-in-text">Recent Posts</h6>
                                </div>
                                <ul class="recent">
                                    <li>
                                        <div class="thum"> <img src="img/slider/2.jpg" class="img-fluid" alt=""> </div>
                                        <a href="post.php">How to Rent a Car at the Airport Terminal?</a>
                                    </li>
                                    <li>
                                        <div class="thum"> <img src="img/slider/19.jpg" class="img-fluid" alt=""> </div>
                                        <a href="post.php">Penalties for violating the rules in rental cars</a>
                                    </li>
                                    <li>
                                        <div class="thum"> <img
                                                src="img/slider/african-american-business-man-car_1303-9853.avif"
                                                class="img-fluid" alt=""> </div> <a href="post.php">How to check a car
                                            before renting?</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="widget">
                                <div class="widget-title">
                                    <h6 class="fade-in-text">Archives</h6>
                                </div>
                                <ul>
                                    <li><a href="#">December 2025</a></li>
                                    <li><a href="#">November 2025</a></li>
                                    <li class="mb-15"><a href="#">October 2025</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="widget">
                                ...
                                <ul>
                                    <li><a href="#"><i class="ti-angle-right"></i>Car Rental</a></li>
                                    <li><a href="#"><i class="ti-angle-right"></i>Vehicles</a></li>
                                    <li><a href="#"><i class="ti-angle-right"></i>Rent A Car</a></li>
                                    <li class="mb-15"><a href="#"><i class="ti-angle-right"></i>Rental Service</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-12">

    ...
    <header class="header slider">
        <div class="owl-carousel owl-theme">
            ...
            <!--<div class="text-center item bg-img" data-overlay-dark="4"
                data-background="img/slider/african-american-business-man-car_1303-9853.avif"></div>-->
            ...
            <!--<div class="text-center item bg-img" data-overlay-dark="4"
                data-background="img/cars/ccar-insurance-tablet-black-woman-portrait-with-motor-evaluation-inspection-from-hire-road-trip-digital-accident-report-auto-search-outdoor-w.avif">
            </div>-->
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="row mb-60">
                        <div class="col-md-12">
                            ...
                            <div class="section-title">VIP Transfer</div>
                            <p>Experience luxury and exclusivity with our VIP Transfer services. Whether you're heading
                                to a corporate event, a special occasion, or simply desire premium comfort, we provide
                                high-end vehicles with professional chauffeurs to ensure a seamless journey.<br>
                            <h3>Options for VIP Transfers</h3><i>Luxury Chauffeur Service </i>- Travel in style with
                            our executive fleet and professional drivers.<br><i>Corporate Transfers </i>- Reliable,
                            punctual, and elegant transport for business executives.<br><i>Event Transfers</i>- Arrive
                            in
                            sophistication at weddings, red carpet events, and VIP gatherings.
                            </p>
                            <h3>Booking in Advance</h3>
                            <p class="mb-30">To ensure a seamless and stress-free travel experience, we offer the option
                                to book your rides in advance. Whether you need a chauffeur for business, airport
                                transfers, or special occasions, early booking guarantees vehicle availability and
                                timely service. Our system allows you to schedule pickups according to your itinerary,
                                giving you peace of mind and convenience.</p>
                            <h3>Luggage Handling</h3>
                            <p class="mb-30">Our professional drivers assist with luggage handling, ensuring your
                                belongings are safely loaded and unloaded with care. Whether you're traveling with light
                                bags or heavy suitcases, we provide a hassle-free experience from the moment you arrive
                                until your final destination. Our vehicles also have ample storage space to accommodate
                                all your luggage needs comfortably.</p>
                            ...
                            <ul class="accordion-box clearfix">
                                <li class="accordion block">
                                    ...
                                    <div class="acc-content">
                                        <div class="content">
                                            <div class="text">Our drivers are fully licensed, professionally trained,
                                                and background-checked to ensure your safety. We adhere to all
                                                transportation regulations and maintain our vehicles to the highest
                                                standards, providing a secure and reliable ride.</div>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block">
                                    ...
                                    <div class="acc-content">
                                        <div class="content">
                                            <div class="text">For your convenience, we accept multiple payment methods,
                                                including local currency and digital transactions. While tipping is
                                                optional, it is always appreciated as a gesture of gratitude for
                                ...
                                <li class="accordion block">
                                    ...
                                    <div class="acc-content">
                                        <div class="content">
                                            <div class="text">Our multilingual support team is available to assist you,
                                                ensuring smooth communication throughout your journey. Drivers are
                                                equipped with modern GPS systems and communication tools to provide
                                ...
                                <li class="accordion block">
                                    ...
                                    <div class="acc-content">
                                        <div class="content">
                                            <div class="text">We strive to make transportation accessible for everyone.
                                                Our fleet includes vehicles designed for passengers with mobility needs,
                                                and our team is ready to offer assistance upon request.</div>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="sidebar-page">
                        ...
                        <div class="item">
                            <div class="features"><span><i class="ti-arrow-top-right"></i> Corporate Car Rental</span>
                            </div>
                            <div class="features"><span><i class="ti-arrow-top-right"></i> Car Rental with Driver</span>
                            </div>
                            ...
                            <div class="features active"><span><i class="ti-arrow-top-right"></i> VIP Transfer</span>
                            </div>

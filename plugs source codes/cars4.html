                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="cars4.html" class="dropdown-item active"><span>Car Listing</span></a></li>
                            <li class="dropdown-submenu dropdown"> <a class="dropdown-item dropdown-toggle"
                                    data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"
        ...
        <div class="v-middle">
            <div class="container">
                <div class="col-md-12 text-center">
                    <h6 class="fade-in-text">Rent Now</h6>
                        ...
                        <div class="item">
                            ...
                            <div class="filter-radio-group">
                                <div class="form-group">
                                    ...
                                    <label for="test1">Lamborghini</label>
                                </div>
                                <div class="form-group">
                                    <input type="radio" id="test2" name="radio-group_one">
                                    <label for="test2">Aston Martin</label>
                                </div>
                                <div class="form-group">
                                    <input type="radio" id="test3" name="radio-group_one">
                                    <label for="test3">Bugatti</label>
                                </div>
                                <div class="form-group">
                                    <input type="radio" id="test4" name="radio-group_one">
                                    <label for="test4">Bentley</label>
                                </div>
                                <div class="form-group">
                                    <input type="radio" id="test5" name="radio-group_one">
                                    <label for="test5">Rolls-Royce</label>
                                </div>
                                <div class="form-group">
                                    <input type="radio" id="test6" name="radio-group_one">
                                    <label for="test6">Audi</label>
                                </div>
                                <div class="form-group">
                                    <input type="radio" id="test7" name="radio-group_one">
                                    <label for="test7">Ferrari</label>
                                </div>
                            </div>
                            <h5>Car Type</h5>
                            <div class="filter-radio-group">
                                <div class="form-group">
                                    ...
                                    <label for="test8">Luxury Cars</label>
                                </div>
                                <div class="form-group">
                                    <input type="radio" id="test9" name="radio-group_two">
                                    <label for="test9">Sport Cars</label>
                                </div>
                                <div class="form-group">
                                    <input type="radio" id="test10" name="radio-group_two">
                                    <label for="test10">SUVs</label>
                                </div>
                                <div class="form-group">
                                    <input type="radio" id="test11" name="radio-group_two">
                                    <label for="test11">Convertible</label>
                                </div>
                            </div>
                            <h5>Transmission</h5>
                            <div class="filter-radio-group">
                                ...
                                <div class="form-group">
                                    <input type="radio" id="test13" name="radio-group_three">
                ...
                <div class="col-lg-8 col-md-12 car-list">
                    <div class="row">
                        <div class="col-lg-6 col-md-12 mb-30">
                            <div class="item">
                                <figure><img src="img/slider/7.jpg" alt="" class="img-fluid"></figure>
                                <div class="content">
                                    <div class="cont">
                                        ...
                                        <div class="book mt-30">
                                            <div>
                                                <div class="price">Kes 90,000 <span>/ day</span></div>
                                            </div> <a href="car-details.html" class="button-1">Deatils</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    <div class="cont">
                                        ...
                                        <div class="book mt-30">
                                            <div>
                                                <div class="price">Kes 65,000 <span>/ day</span></div>
                                            </div> <a href="car-details.html" class="button-1">Deatils</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    <div class="cont">
                                        ...
                                        <div class="book mt-30">
                                            <div>
                                                <div class="price">kes 95000 <span>/ day</span></div>
                                            </div> <a href="car-details.html" class="button-1">Deatils</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12 mb-30">
                            <div class="item">
                                <figure><img src="img/slider/12.jpg" alt="" class="img-fluid"></figure>
                                <div class="content">
                                    <div class="cont">
                                        ...
                                        <div class="book mt-30">
                                            <div>
                                                <div class="price">Kes 102,000 <span>/ day</span></div>
                                            </div> <a href="car-details.html" class="button-1">Deatils</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12 mb-30">
                            <div class="item">
                                <figure> <img src="img/slider/13.jpg" alt="" class="img-fluid"> </figure>
                                <div class="content">
                                    <div class="cont">
                                        ...
                                        <div class="book mt-30">
                                            <div>
                                                <div class="price">kes 55000 <span>/ day</span></div>
                                            </div> <a href="car-details.html" class="button-1">Deatils</a>
                                        </div>
                                    </div>
                                </div>
